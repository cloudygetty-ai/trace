      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 flex flex-col gap-4">
        ...
        <div className="glass-card border border-amber/10 rounded-2xl overflow-hidden">
          {[
            ...
            <div key={r.label} className="flex items-center gap-3 px-4 py-4 border-b border-amber/10 last:border-none">
          ...
          <div className="px-4 py-4 border-t border-amber/10 flex items-center gap-3">
