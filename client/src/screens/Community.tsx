  ...
  return (
    <div className="flex flex-col h-full bg-bg">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="mx-4 mt-4 bg-cyan/5 border-l-2 border-cyan rounded-r-xl p-3 text-[11px] text-cyan/70 leading-relaxed">
        ...
        <div className="flex items-center justify-between px-4 mt-5 mb-3">
          <span className="text-[15px] font-semibold">Lost Dogs Near You</span>
          <button onClick={() => nav('/map')} className="font-mono text-[10px] text-cyan">Map view</button>
        </div>

        <div className="px-4 flex flex-col gap-3">
          <div onClick={() => nav('/report/luna')} className="bg-s1 border border-warn/30 rounded-2xl p-4 flex gap-3 cursor-pointer active:scale-[.98]">
            <div className="w-14 h-14 rounded-xl bg-s3 border border-border flex items-center justify-center text-3xl flex-shrink-0">🐕</div>
          ...
          <div onClick={() => nav('/report')} className="bg-s1 border border-border rounded-2xl p-4 flex gap-3 cursor-pointer active:scale-[.98]">
            <div className="w-14 h-14 rounded-xl bg-s3 border border-border flex items-center justify-center text-3xl flex-shrink-0">🐩</div>
            <div className="flex-1">
            ...
            <button className="self-center bg-s2 border border-border text-muted2 font-mono text-[9px] h-8 px-3 rounded-xl">Seen</button>
          </div>
        </div>

        <div className="flex items-center justify-between px-4 mt-5 mb-3">
          <span className="text-[15px] font-semibold">Your Relay Status</span>
        </div>
        <div className="mx-4 bg-s1 border border-border rounded-2xl p-4 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-3 gap-3 text-center border-t border-border pt-4">
            <div><p className="font-mono text-xl font-bold text-cyan">3</p><p className="font-mono text-[8px] text-muted2">NEARBY</p></div>
