...
function SettingRow({ icon, title, sub, right }: any) {
  return (
    <div className="flex items-center gap-3 px-4 py-3.5 border-b border-amber/15 last:border-none">
      <div className="w-8 h-8 rounded-xl bg-surface border border-amber/15 rounded-2xl border border-amber/15 flex items-center justify-center text-base flex-shrink-0">{icon}</div>
  ...
  return (
    <div className="flex flex-col h-full bg-bg">
      ...
      <div className="flex-1 overflow-y-auto pb-8">
        ...
        <div className="mx-4 mb-2 font-mono text-[9px] text-muted uppercase tracking-[.1em]">Alert Preferences</div>
        <div className="mx-4 bg-surface border border-amber/15 rounded-2xl border border-amber/15 rounded-2xl overflow-hidden">
          ...
          <SettingRow icon="📧" title="Email Digest" sub="Daily summary" right={<span className="font-mono text-[10px] text-muted">›</span>}/>
        </div>

        <div className="mx-4 mt-5 mb-2 font-mono text-[9px] text-muted uppercase tracking-[.1em]">Relay & Privacy</div>
        <div className="mx-4 bg-surface border border-amber/15 rounded-2xl border border-amber/15 rounded-2xl overflow-hidden">
          ...
          <SettingRow icon="📍" title="Location Precision" sub="Relay sightings use 100m grid" right={<span className="font-mono text-[10px] text-muted">100m ›</span>}/>
        ...
        <div className="mx-4 mt-5 mb-2 font-mono text-[9px] text-muted uppercase tracking-[.1em]">Account</div>
        <div className="mx-4 bg-surface border border-amber/15 rounded-2xl border border-amber/15 rounded-2xl overflow-hidden">
